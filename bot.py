...
# # bot.py (v21 - Full Admin Panel Integration)
# import os
# import asyncio
# import pandas as pd
# import requests
...
#     keyboard = [["User Stats 👥", "Withdrawals 🏧"], ["Back to Main Menu ⬅️"]]
#     reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True)
...
# async def photo_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
#     """
#     УМНАЯ ОБРАБОТКА ГРАФИКОВ С ИМПУЛЬСНЫМ АНАЛИЗОМ И ПРОВЕРКОЯ ПОДПИСКИ
#     """
#     user = update.message.from_user
#     user_id = user.id
...
# def main():
#     print("Starting bot with Enhanced Subscription & Referral System & Admin Panel...")
#     application = Application.builder().token(TELEGRAM_TOKEN).build()
...
# # bot.py (v21 - Full Admin Panel Integration + View Chart Button)
# import os
# import asyncio
# import pandas as pd
# import requests
...
# def main():
#     print("Starting bot with Enhanced Subscription & Referral System & Admin Panel & View Chart...")
#     application = Application.builder().token(TELEGRAM_TOKEN).build()
